...
<table class="table table-sm">
    ...
    <tr>
        ...
        <th scope="col">Customer Street Nr</th>
        <th scope="col">Customer Street Add.</th>
    ...
    <tr>
        ...
        <td><?php echo $customer['customerStreet'] ?></td>
        <td><?php echo $customer['customerStreetNr'] ?></td>
        <td><?php echo $customer['customerStreetAdditional'] ?></td>
